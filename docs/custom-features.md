...
| [Haptic Feedback](https://github.com/mkuczera/react-native-haptic-feedback) | React-Native Haptic Feedback for iOS with Android similar behaviour. | DeckCards & MultiSwitch |
...
| MultiSwitch | Hacked from [Slider Switch](https://github.com/victorkvarghese/rn-slider-switch) - Multi slider switch component in React-Native (iOS & Android) | ExerciseModality.js |
