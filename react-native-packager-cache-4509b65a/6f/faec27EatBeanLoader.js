    ...
    babelHelpers.createClass(EatBeanLoader, [{
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(Shape, { d: d, fill: color, x: size / 5 }),
                this.state.dotsY.map(function (item, i) {
                    return _react2.default.createElement(_AnimatedCircle2.default, { key: i, radius: size / 5, fill: color, x: item, y: size / 2 });
                })
            );
        }
    }, {
