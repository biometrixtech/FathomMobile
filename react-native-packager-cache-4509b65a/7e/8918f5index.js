...
var ModalBox = React.createClass({
  ...
  renderBackdrop: function renderBackdrop(size) {
    ...
    if (this.props.backdrop) {
      backdrop = React.createElement(
        ...
        React.createElement(
          Animated.View,
          { style: [styles.absolute, size, { opacity: this.state.backdropOpacity }] },
  ...
  render: function render() {
    ...
    return React.createElement(
      View,
      { style: [styles.transparent, styles.absolute], pointerEvents: 'box-none', onLayout: this.onContainerLayout },
      backdrop,
      React.createElement(
        Animated.View,
