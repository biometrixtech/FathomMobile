...
const bodyPartMapping = [
    ...
    {index: 11, order: 13, label: 'Outer Thigh', front: true, location: 'lower body', group: 'muscle', image: {0: 'ITBand.svg', 1: 'L_ITBand.svg', 2: 'R_ITBand.svg'}, bilateral: true, helping_verb: 'has'},
    {index: 11, order: 13, label: 'Outer Thigh', front: false, location: 'lower body', group: 'muscle', image: {0: 'ITBand_Back.svg', 1: 'L_ITBand_Back.svg', 2: 'R_ITBand_Back.svg'}, bilateral: true, helping_verb: 'has'},
    ...
    {index: 79, order: null, label: 'Lower Trapezius', front: false, location: 'upper body', group: 'muscle', image: {0: 'LowerTraps.svg', 1: 'L_LowerTraps.svg', 2: 'R_LowerTraps.svg'}, bilateral: false, helping_verb: 'has'},
