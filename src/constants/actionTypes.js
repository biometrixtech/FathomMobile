...
export default {
    ...
    CLEAR_COMPLETED_COOL_DOWN_EXERCISES: 'CLEAR_COMPLETED_COOL_DOWN_EXERCISES',
    ...
    SET_ACTIVE_REST_GOALS:               'SET_ACTIVE_REST_GOALS',
    SET_COMPLETED_COOL_DOWN_EXERCISES:   'SET_COMPLETED_COOL_DOWN_EXERCISES',
    SET_COMPLETED_EXERCISES:             'SET_COMPLETED_EXERCISES',
    SET_COMPLETED_FS_EXERCISES:          'SET_COMPLETED_FS_EXERCISES',
    SET_COOL_DOWN_GOALS:                 'SET_COOL_DOWN_GOALS',
    SET_ENVIRONMENT:                     'SET_ENVIRONMENT',
    SET_HEALTH_DATA:                     'SET_HEALTH_DATA',
    SET_TYPICAL_SESSIONS:                'SET_TYPICAL_SESSIONS',
    SET_WARM_UP_GOALS:                   'SET_WARM_UP_GOALS',
    SIGN_UP_FAILED:                      'SIGN_UP_FAILED',
    SIGN_UP_SUCCESS:                     'SIGN_UP_SUCCESS',
    START_REQUEST:                       'START_REQUEST',
    STOP_REQUEST:                        'STOP_REQUEST',
    TOGGLE_ACTIVE_REST_GOAL:             'TOGGLE_ACTIVE_REST_GOAL',
    TOGGLE_COOL_DOWN_GOAL:               'TOGGLE_COOL_DOWN_GOAL',
    TOGGLE_WARM_UP_GOAL:                 'TOGGLE_WARM_UP_GOAL',
