 ...
 * @Last Modified time: 2018-03-30 14:49:40
 */
...
export default {
    ...
    chart: {
        ...
        symmetry: [
            ...
            { max: 88, min: 70, color: AppColors.primary.yellow, cardColor: AppColors.primary.yellow.fiftyPercent, title: 'Asymmetric Movement Pattern', detectionResponse: 'You\'re distributing stress throughout your body asymmetrically.', recommedationResponse: 'If this is due to asymmetry in your training plans, consider balancing your activities to decrease accumulated effects. Else, you may be compensating and are not ready for the volume or intensity of your training. Decrease your training intensity and strengthen in controlled settings.' }
        ],
        hipSymmetry: [
            ...
            { max: 88, min: 70, color: AppColors.primary.yellow, cardColor: AppColors.primary.yellow.fiftyPercent, title: 'Asymmetric Hip Movement Pattern', detectionResponse: 'You\'re distributing stress throughout your body asymmetrically at the hips.', recommedationResponse: 'If this is due to asymmetry in your training plans, consider balancing your activities to decrease accumulated effects. Else, you may be compensating and are not ready for the volume or intensity of your training. Decrease your training intensity and strengthen in controlled settings.' }
        ],
        ankleSymmetry: [
            ...
            { max: 88, min: 70, color: AppColors.primary.yellow, cardColor: AppColors.primary.yellow.fiftyPercent, title: 'Asymmetric Ankle Movement Pattern', detectionResponse: 'You\'re distributing stress throughout your body asymmetrically at your ankles.', recommedationResponse: 'If this is due to asymmetry in your training plans, consider balancing your activities to decrease accumulated effects. Else, you may be compensating and are not ready for the volume or intensity of your training. Decrease your training intensity and strengthen in controlled settings.' }
        ],
        control: [
