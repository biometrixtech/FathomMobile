/*
 * @Author: Vir Desai 
 * @Date: 2018-04-23 15:04:01 
 * @Last Modified by:   Vir Desai 
 * @Last Modified time: 2018-04-23 15:04:01 
 */
...
class Calendar extends Component {
  static propTypes = {
      ...
      // Handler which gets executed when press month title. It receive a callback can hide calendar
  ...
  pressDay(date) {
      ...
      if (!(minDate && !dateutils.isGTE(day, minDate)) && !(maxDate && !dateutils.isLTE(day, maxDate))) {
          const shouldUpdateMonth = this.props.disableMonthChange === null || !this.props.disableMonthChange;
      ...
      return (
          <View style={[this.style.container, this.props.style]}>
              <CalendarHeader
                  ...
                  onPressTitle={this.props.onPressTitle}
