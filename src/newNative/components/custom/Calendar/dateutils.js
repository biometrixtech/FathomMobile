/*
 * @Author: Vir Desai 
 * @Date: 2018-04-23 15:03:04 
 * @Last Modified by:   Vir Desai 
 * @Last Modified time: 2018-04-23 15:03:04 
 */
...
function month(xd) {
    ...
    const currentMonth = xd.getMonth();
    const days = new Date(year, currentMonth + 1, 0).getDate();

    const firstDay = new XDate(year, currentMonth, 1, 0, 0, 0, true);
    const lastDay = new XDate(year, currentMonth, days, 0, 0, 0, true);
