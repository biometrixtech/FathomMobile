...
class BluetoothConnectView extends Component {
    ...
    handleDiscoverPeripheral = (data) => {
        ...
        // return data.name && /fathomK_/i.test(data.name) ? this.props.deviceFound(data) : null; // 3 sensor solution
            ...
            >
                ...
                <View style={[AppStyles.containerCentered, { flex: 1 }]}>
                    ...
                    <TabIcon
                        ...
                        onPress={() => {
                            this.startBluetooth().then(() => this.toggleScanning(!this.props.bluetooth.scanning));
                            this.setState({ index: 2 });
                            this.pages.progress = 2;
                        }}
                        raised
