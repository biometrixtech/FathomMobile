 ...
 * @Last Modified time: 2018-03-23 14:22:21
 */
                ...
                <View style={[AppStyles.row, { height }]} onLayout={ev => this.setState({ graphHeight: ev.nativeEvent.layout.height })}>
                    <View style={[AppStyles.flex1]}/>
                    {
                        percentageOverall === 0 && percentageToDate === 0 ?
                            <View style={[AppStyles.flex3, AppStyles.containerCentered]}>
                            ...
                            <View style={[AppStyles.flex2, AppStyles.containerCentered]}>
                                <Text h4 style={{ color: AppColors.primary.grey.hundredPercent }}>WEEKLY</Text>
                                <Text h4 style={{ color: AppColors.primary.grey.hundredPercent }}>LOAD</Text>
                                <Text h6 style={{ color: AppColors.primary.grey.hundredPercent, fontWeight: 'bold' }}>COMPARED TO</Text>
                                <Text h6 style={{ color: AppColors.primary.grey.hundredPercent, fontWeight: 'bold' }}>PREVIOUS WEEK</Text>
                            </View>
                    }
                    <TouchableWithoutFeedback onPress={() => percentageOverall === 0 && percentageToDate === 0 ? null : selectGraph(graphIndex, 0)}>
                        <View style={[AppStyles.flex2, AppStyles.containerCentered, { backgroundColor: isGraphSelected ? AppColors.secondary.light_blue.hundredPercent : null }]}>
                            <Svg width={this.state.graphHeight || width} height={this.state.graphHeight || height}>
                                ...
                                />
                                <Circle cx={circleWidth} cy={circleHeight} r={(circleHeight)*0.75} fill={isGraphSelected ? AppColors.secondary.light_blue.hundredPercent : fillColor}/>
                            </Svg>
