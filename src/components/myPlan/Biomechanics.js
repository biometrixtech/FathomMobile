                        ...
                        <View style={{flex: 1, flexDirection: 'column',}}>
                            ...
                            <View style={{backgroundColor: AppColors.white,}}>
                                ...
                                <ScrollView style={{padding: AppSizes.paddingLrg,}}>
                                    ...
                                    <Text robotoLight style={{color: AppColors.zeplin.slate, fontSize: AppFonts.scaleFont(14),}}>{'Leg Extension is the Range of Motion (ROM) of your leg through your stride to derive insights into your ground contact patters all the way through the extension of the leg from your hips. \n\nMany muscles can contribute to asymmetries, but in consideration of other movement patterns observed at your hips (like anterior rotation or hip drop), we try to isolate the source of the movement imbalance.\n\nCommon culprits are asymmetrically tight or shortened psoas, quad, TFL, adductor complex, or sartorius muscles.'}</Text>
                                    <Spacer size={AppSizes.padding} />
                                    <Text robotoBold style={{color: AppColors.zeplin.slate, fontSize: AppFonts.scaleFont(14),}}>{'How It\'s Measured:'}</Text>
