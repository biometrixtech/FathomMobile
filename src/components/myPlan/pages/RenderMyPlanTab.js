...
const RenderMyPlanTab = ({
    ...
    let page0ExtraStyles = {borderBottomColor: isTabActive ? AppColors.zeplin.slate : AppColors.zeplin.slateXLightSlate, borderBottomWidth: 3,};
    let page1ExtraStyles = {borderBottomColor: isTabActive ? AppColors.zeplin.slate : AppColors.zeplin.slateXLightSlate, borderBottomWidth: 3,};
    let page2ExtraStyles = {borderBottomColor: isTabActive ? AppColors.zeplin.slate : AppColors.zeplin.slateXLightSlate, borderBottomWidth: 3,};
            ...
            <View style={[page === 0 ? page0Styles : page === 1 ? page1Styles : page2Styles]}>
                <View style={{alignItems: 'flex-end', flex: 1, flexDirection: 'row', justifyContent: 'center',}}>
                    <Text
                        ...
                        style={{
                            color:    isTabActive ? AppColors.zeplin.slate : AppColors.zeplin.slateXLightSlate,
