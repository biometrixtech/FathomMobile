/*
 * @Author: Vir Desai 
 * @Date: 2018-04-23 15:06:21 
 * @Last Modified by:   Vir Desai 
 * @Last Modified time: 2018-04-23 15:06:21 
 */
...
class ReservationListItem extends Component {
    ...
    renderDate(date, item) {
        if (this.props.renderDay) {
            return this.props.renderDay(date ? xdateToData(date) : null, item);
        }
        const today = dateutils.sameDate(date, XDate()) ? this.styles.today : null;
        if (date) {
            return (
