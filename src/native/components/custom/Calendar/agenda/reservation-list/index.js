/*
 * @Author: Vir Desai 
 * @Date: 2018-04-23 15:06:26 
 * @Last Modified by:   Vir Desai 
 * @Last Modified time: 2018-04-23 15:06:26 
 */
...
class ReactComp extends Component {
  ...
  updateReservations(props) {
      ...
      if (this.list && !dateutils.sameDate(props.selectedDay, this.selectedDay)) {
          ...
          for (let i = 0; i < reservations.scrollPosition; i=i+1) {
  ...
  onScroll(event) {
      ...
      let topRowOffset = 0;
      let topRow;
      for (topRow = 0; topRow < this.heights.length; topRow=topRow+1) {
