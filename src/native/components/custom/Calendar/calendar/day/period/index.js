/*
 * @Author: Vir Desai 
 * @Date: 2018-04-23 15:04:57 
 * @Last Modified by:   Vir Desai 
 * @Last Modified time: 2018-04-23 15:04:57 
 */
...
class Day extends Component {
  ...
  getDrawingStyle(marking) {
      const defaultDrawingStyle = {textStyle: {}};
      if (!marking) {
          return defaultDrawingStyle;
      }
      if (marking.disabled) {
          defaultDrawingStyle.textStyle.color = this.theme.textDisabledColor;
      } else if (marking.selected) {
          defaultDrawingStyle.textStyle.color = this.theme.selectedDayTextColor;
      }
