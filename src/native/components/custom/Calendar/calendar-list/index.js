/*
 * @Author: Vir Desai 
 * @Date: 2018-04-23 15:03:37 
 * @Last Modified by:   Vir Desai 
 * @Last Modified time: 2018-04-23 15:03:37 
 */
...
class CalendarList extends Component {
  ...
  constructor(props) {
      super(props);
      this.pastScrollRange = props.pastScrollRange === null ? 50 : props.pastScrollRange;
      this.futureScrollRange = props.futureScrollRange === null ? 50 : props.futureScrollRange;
  ...
  onViewableItemsChanged({viewableItems}) {
      function rowIsCloseToViewable(index, distance) {
          for (let i = 0; i < viewableItems.length; i=i+1) {
              if (Math.abs(index - parseInt(viewableItems[i].index, 10)) <= distance) {
                  return true;
              }
          }
          return false;
      ...
      const newrows = [];
      const visibleMonths = [];
      for (let i = 0; i < rowclone.length; i=i+1) {
          let val = rowclone[i];
  ...
  render() {
      return (
          <FlatList
              ...
              showsVerticalScrollIndicator={this.props.showScrollIndicator !== null ? this.props.showScrollIndicator : false}
              scrollEnabled={this.props.scrollingEnabled !== null ? this.props.scrollingEnabled : true}
              keyExtractor={(item, index) => String(index)}
              initialScrollIndex={this.state.openDate ? this.getMonthIndex(this.state.openDate) : false}
              getItemLayout={this.getItemLayout}
              scrollsToTop={this.props.scrollsToTop !== null ? this.props.scrollsToTop : false}
          />
      );
  }
}
