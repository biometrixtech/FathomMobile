 ...
 * @Last Modified time: 2018-05-03 13:59:30
 */
...
import { Roles, Thresholds, ErrorMessages, AppColors } from '../../../constants/';
import { AppUtil } from '../../../lib/';

// Components
import { ListItem, Text, CircularProgress, DailyLoadChart, Spacer, Card, Calendar } from '../custom/';
...
class TrainingReport extends Component {
    ...
    preprocessingUpload = (uploadArray, role) => {
        ...
        let white = AppColors.primary.white.hundredPercent;
        let text = '';
        ...
        return <ListItem
            ...
            rightIcon={{ name: 'clear', color: white }}
            ...
            <View>
                {
                    !userData || !userData.stats ? 
                        ...
                        :
                        <ScrollView stickyHeaderIndices={[preprocessingMessages ? 6 : 5]} style={{ height: AppSizes.screen.usableHeight - 10 - TAB_NAVIGATOR_HEIGHT }}>
                            { preprocessingMessages }
                            <Spacer size={user.users.length === 1 ? 10 : 20}/>
                            {
                                user.users.length === 1 ? null :
