...
var _jsxFileName = '/Users/vdesai/Biometrix/FathomMobile/node_modules/react-native-indicator/lib/loader/LinesLoader.js';
    ...
    babelHelpers.createClass(LinesLoader, [{
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                Surface,
                { width: barWidth * barNumber + betweenSpace * (barNumber - 1), height: barHeight, __source: {
                ...
                this.state.heights.map(function (item, i) {
                    return _react2.default.createElement(_AnimatedBar2.default, { key: i, fill: color, width: barWidth, height: _this2.state.heights[i],
                        x: i * (betweenSpace + barWidth), y: barHeight / 2, __source: {
                            fileName: _jsxFileName,
                            lineNumber: 47
                        }
                    });
